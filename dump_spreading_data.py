...
rewiring_percentage_list =[5, 10, 15, 20, 25]#[5, 10, 15, 20, 25]  # [5, 10, 15, 20, 25]

percent_more_edges_list =[5, 10, 15, 20, 25]#[5, 10, 15, 20, 25]  # [5, 10, 15, 20, 25]
    ...
    for network_id in network_id_list:
        ...
        for theta in theta_list:
            ...
            if include_original_networks:
                ...
                df_utility_to_spreads_original = pd.Series(speed_samples_original, name='utility_to_spread')
                ...
                new_df_original = pd.concat([df_common_part_original,
                                             ...
                                             df_utility_to_spreads_original,
            ...
            if include_rewiring_networks:
                ...
                for rewiring_percentage in rewiring_percentage_list:
                    ...
                    df_utility_to_spreads_rewired = pd.Series(speed_samples_rewired, name='utility_to_spread')
            ...
            if include_addition_networks:
                ...
                for percent_more_edges in percent_more_edges_list:
                    ...
                    df_utility_to_spreads_add_random = pd.Series(speed_samples_add_random, name='utility_to_spread')
                    ...
                    new_df_add_random = pd.concat([df_common_part_add_random,
                                                   ...
                                                   df_utility_to_spreads_add_random,
                    ...
                    df_utility_to_spreads_add_triad = pd.Series(speed_samples_add_triad, name='utility_to_spread')
                    ...
                    new_df_add_triad = pd.concat([df_common_part_add_triad,
                                                  ...
                                                  df_utility_to_spreads_add_triad,
            ...
            if include_add_rand_networks:
                ...
                for percent_more_edges in percent_more_edges_list:
                    ...
                    df_utility_to_spreads_add_random = pd.Series(speed_samples_dadd_random, name='utility_to_spread')
